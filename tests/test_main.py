...
def test_main_with_valid_config(temp_config_file, valid_config, default_config):
    ...
    with mock.patch('builtins.open', mock_open), \
         mock.patch('bot_squared.b2.Plugin') as mock_plugin, \
         mock.patch('bot_squared.b2.integrator') as mock_integrator, \
         mock.patch('bot_squared.b2.validate_config') as mock_validate:
